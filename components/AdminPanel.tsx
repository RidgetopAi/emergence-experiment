  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      ...
      <button
        ...
        title={aidisConnected ? "Upload fresh content from AIDIS" : "AIDIS not connected"}
      >
        {isUploading ? (
          <>
      ...
      <div
        ...
        title={`AIDIS ${aidisConnected ? "Connected" : "Disconnected"}`}
      />
      {/* Status Messages - Positioned absolutely to avoid header disruption */}
      {uploadStatus.type && (
